    ...
    <div class="container">
        <div class="deposit-container">
            <div class="left-section">
                ...
                <p>Securely withdraw funds from your account in minutes.</p>
                
            <%String Success=(String)request.getAttribute("withdrwan");%>
            <%if(Success!=null) {%>
            <h5 class="sucs"><%=Success %></h5>
            <%} %>
            
            <%String Failure=(String)request.getAttribute("withdrawfail");%>
            <%if(Failure!=null) {%>
            <h5 class="fail"><%=Failure %></h5>
            <%} %>
            
            <%String Notsufficientbal=(String)request.getAttribute("withdrawinsufficient");%>
            <%if(Notsufficientbal!=null) {%>
            <h5 class="fail"><%=Notsufficientbal %></h5>
            <%} %>
            
            <%String AccNumMissmath=(String)request.getAttribute("withdrawfailAccountNum");%>
            <%if(AccNumMissmath!=null) {%>
            <h5 class="fail"><%=AccNumMissmath %></h5>
            <%} %>
